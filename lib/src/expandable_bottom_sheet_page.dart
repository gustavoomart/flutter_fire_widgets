...
class ExpandableBottomSheetPage extends StatefulWidget {
  ...
  @override
  State<ExpandableBottomSheetPage> createState() => _ExpandableBottomSheetPageState();
}
    ...
    return Stack(
      children: [
        ...
        AnimatedPositioned(
          ...
          right: 0,
          height: isExpanded 
            ? MediaQuery.of(context).size.height * widget.openedHeightPercentage 
            : MediaQuery.of(context).size.height * widget.headerHeightPercentage,
          child: Material(
            elevation: 10,
            ...
            child: Column(
              children: [
                ...
                GestureDetector(
                  onTap: toggleSheet,
                  child: Container(
                    height: MediaQuery.of(context).size.height * widget.headerHeightPercentage,
